...
import com.core.app.data.IView;
...
//先确保是否已经申请过权限
     ...
     * 请求获取手机状态的权限
     */
    public static void readPhonetate(final RequestPermission requestPermission, RxPermissions rxPermissions, RxErrorHandler errorHandler) {
//先确保是否已经申请过权限
        boolean isPermissionsGranted =
                rxPermissions
